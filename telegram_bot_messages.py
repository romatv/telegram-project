...
help_message = 'Welcome to Spotygo Bot!\n' \
               ...
               '2. How to download the playlist?\n' \
               'To initiate the process just send to SpotyGo the link to your playlist.\n' \
               ...
               '5. Is it safe?\n' \
               'Yes, it is totally safe. We don\'t request any user data other than\n' \
               'playlist links and your ZIP contains only mp4 song files.'
